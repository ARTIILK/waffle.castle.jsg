        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-brand-cream/70 mb-6">
              The ultimate destination for premium waffles, pancakes, and thick shakes in Jharsuguda. Treat yourself like royalty today!
            </p>
          ...
          {/* Contact Details */}
          <div>
            <h3 className="text-xl font-bold text-brand-yellow mb-6 display-font">Visit Us Today</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-brand-cream/80">Mon - Sun: 11:00 AM - 11:00 PM</span>
              </li>
            </ul>
          </div>
          ...
          <div className="h-64 rounded-2xl overflow-hidden shadow-lg border-2 border-brand-yellow/20">
            <iframe 
              ...
              title="Waffle Castle Jharsuguda Location"
            ></iframe>
          </div>
        </div>

        <div className="border-t border-brand-yellow/10 pt-8 text-center text-brand-cream/40 text-sm">
          <p>&copy; {new Date().getFullYear()} Waffle Castle Jharsuguda. All rights reserved.</p>
        </div>
